...
export const SkillCards: SkillCard[] = [
    ...
    { text: 'Tailwind CSS', icon: 'https://cdn.sanity.io/images/ohx8wpby/production/96318c38e7abe87e605754762ee885dedd683f58-3000x1799.png' },
    { text: 'Mobile', icon: 'https://cdn.sanity.io/images/ohx8wpby/production/050d1234e6b032e93dbf02aec82f8dd567857f11-512x512.png' },
    { text: 'Mongo DB', icon: 'https://cdn.iconscout.com/icon/free/png-512/mongodb-4-1175139.png' },
    { text: 'Github', icon: 'https://cdn.iconscout.com/icon/free/png-512/github-170-1175028.png' },
    { text: 'Firebase', icon: 'https://cdn.iconscout.com/icon/free/png-512/firebase-1-282796.png' },
    { text: 'Responsive', icon: 'https://cdn.iconscout.com/icon/free/png-512/responsive-design-3-1175101.png' },
    { text: 'Bootstrap', icon: 'https://cdn.iconscout.com/icon/free/png-512/bootstrap-226077.png' },
    { text: 'Node js', icon: 'https://cdn.iconscout.com/icon/free/png-512/node-js-1174925.png' },
];


export const AbilitiesCards: AbilitiesCard[] = [
    { text: 'Team worker', image: 'https://www.liquidplanner.com/wp-content/uploads/2019/04/HiRes-44-e1478037191772-1024x547.jpg' },
    { text: 'Adaptability', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS79iz-1kAPsk59dClvPjyZTNT9qAeUhXdD7w&s' },
